...
"""
For cache we use linkedlist so adding new item to list is easy and every time new item is added at the start of LL.
removing item is also easy
In additionw e have hashtable that maps query to the corrosponding node in linked list.
"""
...
class LRUCache(object):
    ...
    def insertItem(self, item):
        ...
        if item.key in self.hash:
            ...
            # the front of item_list. and add it to hash table also
