...
# algorithm runs with o(n) run time complexity
# Driver function to test above function
arr = [1, -2, -3, 0, 7, -8, -2]
print "Maximum product sub array is", max_sub_array_product(arr)
print "Maximum product sub array is", max_sub_array_product([2, 3, -2, -5, 0, 4])
